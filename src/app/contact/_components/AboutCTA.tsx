  ...
  return (
    <section className="border border-neutral-800 p-4 sm:p-6 md:p-10 lg:p-20">
      <div className="flex flex-col gap-12">
        ...
        {/* Bottom CTA */}
        <FadeIn>
          <div className="flex flex-col gap-6 border border-neutral-800 bg-neutral-800/20 p-6 backdrop-blur-md lg:flex-row lg:items-center lg:justify-between lg:px-10">
            ...
            <MagneticButton>
              <Link
                href="#"
                className="inline-flex items-center justify-center bg-lime-400 px-8 py-4 text-lg font-medium text-zinc-900 transition duration-300 hover:opacity-90"
              >
                Start Project
              </Link>
            </MagneticButton>
